    ...
    <div className="footer__container">
      <div className="footer__container__content">
        ...
        <div className="footer__container__content__right">
          <div className="footer__container__content__right__quick__links">
            <div className="footer__container__content__right__quick__links__heading">
              Quicklinks
            </div>
            <div className="footer__container__content__right__link">
              <a href="">Home</a>
            </div>
            <div className="footer__container__content__right__link">
              <a href="">About</a>
