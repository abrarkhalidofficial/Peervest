      ...
      <div className="homepage__main__container">
        ...
        <div className="container">
          <div className="container__startups">
            <div className="container__startups__card">
            ...
            <div className="container__startups__card container__startups__card__reverse">
              <div className="container__startups__card__left">
                <svg
                  id="Group_14"
                  data-name="Group 14"
          ...
          <div className="footer__container">
            <div className="footer__container__content">
              <div className="footer__container__content__heading">
                <span>PEERVEST</span> Provides Digital Trust, Enabling Us To
